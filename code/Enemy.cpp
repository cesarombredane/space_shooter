...
Enemy::Enemy(int vie, int vitesse, int damage, int t) {
	if (!bufferHit_enemy.loadFromFile("files/sons/impact_enemy.wav")) {
...
void Enemy::move_enemy(string s) {
	...
	case 0:
		// droite //////////////////////////////////////
		if (!colRight) posEnemy.x += vitesseEnemy;
		else {
			if (colDown) posEnemy.y -= vitesseEnemy;
			else if (colTop) posEnemy.y += vitesseEnemy;
		}
		break;
		////////////////////////////////////////////////
	case 1:
		...
		if (!colRight && !colLeft) {
			...
			if (colRight) posEnemy.y += vitesseEnemy;
			if (colLeft) posEnemy.x += vitesseEnemy;
		}
		break;
		////////////////////////////////////////////////
	case 2:
		...
		if (!colDown) posEnemy.y += vitesseEnemy;
			...
			if (colRight) posEnemy.x -= vitesseEnemy;
			else if (colLeft) posEnemy.x += vitesseEnemy;
		}
		break;
		////////////////////////////////////////////////
		break;
	case 3:
		...
		if (!colRight && !colLeft) {
			...
			if (colRight) posEnemy.x -= vitesseEnemy;
			if (colLeft) posEnemy.y += vitesseEnemy;
		}
		break;
		////////////////////////////////////////////////
	case 4:
	...
	case 6:
		// haut //////////////////////////////////////
		if (!colTop) posEnemy.y -= vitesseEnemy;
		else {
			if (colRight) posEnemy.x -= vitesseEnemy;
			else if (colLeft) posEnemy.x += vitesseEnemy;
		}
